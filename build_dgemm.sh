...
BUILD_CMD="-o xtest "${CCFLAGS[@]}" src/main.c kernel_avx2_8regs.o kernel_sse2_8regs.o kernel_avx2_16regs.o utils.o -I"${MKL_PATH}" "${MKL_LIB}" -L"${OMP_PATH}" -qopenmp -lpthread "${LFLAGS[@]}" "${@}
echo $CC $OBJ_CMD
echo $CC $BUILD_CMD
$CC $OBJ_CMD
$CC $BUILD_CMD
