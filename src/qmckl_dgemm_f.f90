module qmckl_dgemm
  ...
  interface
     integer (qmckl_exit_code) function qmckl_tile_matrix_destroy(tile_matrix) bind(C)
       use, intrinsic :: iso_c_binding
       import
       integer (qmckl_tile_matrix), intent(in), value :: tile_matrix
   ...
   integer(c_int32_t) function qmckl_pack_matrix &
       (context, tile_matrix, mType, m, n, A, lda) &
       bind(C)
     use, intrinsic :: iso_c_binding
     import
     implicit none
