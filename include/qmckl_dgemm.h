...
qmckl_exit_code qmckl_pack_matrix(qmckl_context context, qmckl_packed_matrix packed_matrix, unsigned char mType, int64_t M8, int64_t N8, double *A, int64_t LDA);
